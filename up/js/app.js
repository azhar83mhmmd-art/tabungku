...
const App = (() => {
  ...
  function init(){
    ...
    SettingsModule.applyCustomBg(settings.customBg);
    ...
    SettingsModule.init();
    AIAssistant.init();
    if (typeof UpdateCheck !== 'undefined') UpdateCheck.init();
    setupQuickAmounts();
  ...
  function renderStats(){
    ...
    if (typeof BarcodeScanner !== 'undefined' && BarcodeScanner.renderStatsSection) BarcodeScanner.renderStatsSection();
  }
